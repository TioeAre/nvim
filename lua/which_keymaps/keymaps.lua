...
wk.register({
	["<leader>"] = {
		...
		c = {
			-- akinsho/bufferline.nvim
			name = "close bufferline|window/code action/vale add accept.txt/create docs",
			...
			v = "lsp vale add word to accept.txt",
		...
		r = {
			...
			-- nvimdev/lspsaga.nvim
			n = "lspsaga smart rename",
			a = "use cmd Lspsaga project_replace old new",
			-- thibthib18/ros-nvim
